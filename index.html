...
<header>
	<main>
		...
		<section>
			<h3>Welcome To UPES Airlines</h3>
			<h1>DO FLY & VISIT<span class="change_content"> </span> <span style="margin-top: -10px;"> | </span> </h1>
			<p>"India once is not enough"</p>
			<a href="About.php" class="btnone">learn more</a>
